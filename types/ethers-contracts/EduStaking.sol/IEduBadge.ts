...
import type { TypedContractEvent, TypedDeferredTopicFilter, TypedEventLog, TypedListener, TypedContractMethod } from "../common.js"
  ...
  export interface IEduBadgeInterface extends Interface {
  ...
  export interface IEduBadge extends BaseContract {
    
    connect(runner?: ContractRunner | null): IEduBadge;
    waitForDeployment(): Promise<this>;

    interface: IEduBadgeInterface;
